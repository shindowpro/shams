...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[819], {
    9220: (e, t, n) => {
        ...
        class _default extends elementorModules.ViewModule {
            ...
            } attachDocumentClass(e) { const t = e.data(), n = t.elementorId, i = t.elementorType, s = this.documentClasses[i] || this.documentClasses.base; this.documents[n] = new s({ $element: e, id: n }) }
        }
        t.default = _default
    },
    9804: (e, t, n) => {
        var i = n(7914), s = i(n(6397)), o = i(n(9320)), r = i(n(7537)); e.exports = function (e) {
            const t = {};
            ...
            const addElementsHandlers = () => {
                this.elementsHandlers.section = o.default,
                    ...
                    e.each(this.elementsHandlers, ((e, t) => {
                        const n = e.split(".");
                        e = n[0]; const i = n[1] || null; this.attachHandler(e, t, i)
                    }))
            },
                isClassHandler = e => {
                    var t;
            ...
            this.addHandler = function (e, n) {
                ...
                let s;
                if (i) { s = e.prototype.getConstructorID(), t[i] || (t[i] = {}); const n = t[i][s]; n && n.onDestroy() }
                const o = new e(n);
                i && (t[i][s] = o)
            },
                ...
                this.getHandler = function (e) {
                    ...
                    return isClassHandler(t) ? t : new Promise((e => { t().then((({ default: t }) => { e(t) })) }))
                },
    ...
    5654: (e, t, n) => {
        ...
        class Frontend extends elementorModules.ViewModule {
            ...
            getPageSettings(e) {
                const t = this.isEditMode() ? elementor.settings.page.model.attributes : this.config.settings.page; return this.getItems(t, e)
