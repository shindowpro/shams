(() => {
    ...
    r.m = v,
        ...
        r.O = (o, t, i, f) => {
            if (!t) {
                ...
                for (n = 0; n < e.length; n++) {
                    for (var [t, i, f] = e[n], s = !0, u = 0; u < t.length; u++)
                        (!1 & f || a >= f) && Object.keys(r.O).every(b => r.O[b](t[u])) ? t.splice(u--, 1) : (s = !1,
                            f < a && (a = f));
                    if (s) {
                        e.splice(n--, 1);
                        var d = i();
        ...
        ,
        r.f = {},
        r.e = e => Promise.all(Object.keys(r.f).reduce((o, t) => (r.f[t](e, o),
            o), [])),
        r.u = e => (592 === e ? "common" : e) + "." + {
            217: "2587fec6806df21e",
            291: "65c4fe8e7995738a",
            592: "eb9413f858fc21d5",
            859: "67809a7596e5d07c",
            877: "46ab160f89ccf92c"
        }[e] + ".js",
        r.miniCssF = e => { }
        ,
                ...
                if (e[t])
                    ...
                    if (void 0 !== f)
                        for (var u = document.getElementsByTagName("script"), d = 0; d < u.length; d++) {
                            var l = u[d];
                            if (l.getAttribute("src") == t || l.getAttribute("data-webpack") == o + f) {
                                a = l;
                                break
                            }
                        }
        ...
        (() => {
            ...
            var o = (i, f) => {
                ...
                for (i && i(f); l < n.length; l++)
                    r.o(e, d = n[l]) && e[d] && e[d][0](),
                        e[n[l]] = 0;
                return r.O(c)
            }
                , t = self.webpackChunkstroyka = self.webpackChunkstroyka || [];
